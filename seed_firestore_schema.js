    ...
    const admins = [
        {
            ...
            password: "$2b$10$hashedPasswordPlaceholder1", // Hashed
            role: "SUPER_ADMIN",
            isActive: true,
        ...
        },
        {
            ...
            password: "$2b$10$hashedPasswordPlaceholder2",
            role: "MANAGER",
            isActive: true,
            createdAt: serverTimestamp()
        },
        {
            ...
            password: "$2b$10$hashedPasswordPlaceholder3",
            role: "STAFF",
            isActive: true,
            createdAt: serverTimestamp()
        }
...
async function seedProducts(categoryIds, subCatIds) {
    ...
    const getCatId = (name) => categoryIds.find(c => c.name === name)?.id || "";
    const getSubCatId = (name) => subCatIds.find(s => s.name === name)?.id || "";
